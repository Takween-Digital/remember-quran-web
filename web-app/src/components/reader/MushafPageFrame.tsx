    ...
    >
      ...
      >
        ...
        <div className="relative rounded-xs border-2 border-reader-paper-gilt p-0.5 sm:p-1 md:p-1.5 h-full flex flex-col min-h-0">
          <div className="relative rounded-xs border border-reader-paper-gilt/60 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2.5 flex-1 flex flex-col min-h-0">
