/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5631c346895f0f15405c608452022ac4)
...
interface __BaseEnv_Env {
	...
	AUTH_URL: string;
	AUTH_SECRET: string;
	NEXT_PUBLIC_QURAN_CHAPTERS_API_URL: string;
	NEXT_PUBLIC_QURAN_QDC_API_URL: string;
	NEXT_PUBLIC_QURAN_WORD_AUDIO_URL: string;
	...
	HOSTINGER_EMAIL_PASSWORD: string;
